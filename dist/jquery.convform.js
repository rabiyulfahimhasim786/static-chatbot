...
// define the available appointment slots
const slots = [
    { start: '2023-05-03 09:00', end: '2023-05-03 10:00' },
    { start: '2023-05-03 11:00', end: '2023-05-03 12:00' },
    { start: '2023-05-04 10:00', end: '2023-05-04 11:00' },
    { start: '2023-05-04 13:00', end: '2023-05-04 14:00' },
    { start: '2023-05-05 14:00', end: '2023-05-05 15:00' },
    { start: '2023-05-05 16:00', end: '2023-05-05 17:00' },
  ];
  ...
  const options = slots.map(slot => {
    ...
    return `<option value="${slot.start}">${start} to ${end}</option>`;
  });
  
  // add options to select element
  $('.appointment-slots').append(options);
...
//     allDaySlot: false,
//     weekends: false,
//     events: slots.map(slot => ({ title: 'Available', start: slot.start, end: slot.end })),
//     eventClick: function(info) {
//       // handle event click
//       console.log(`Clicked slot: ${info.event.start} to ${info.event.end}`);
//     }
//   });
